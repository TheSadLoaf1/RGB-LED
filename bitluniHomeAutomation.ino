...
void handleRoot() {
  ...
  message += "<a href='/setleds?r=32&b=64&g=32&fade=1000'>/setleds</a> sets LEDs to the color from arguments: r=<0..255> g=<0..255> b=<0..255><br>";
...
void handleRf()
{
	const int pinNumbers[] = {0, 1, 2, 3, 4, 5, 6, 7, 8};
